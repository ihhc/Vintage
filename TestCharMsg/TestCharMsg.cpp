// TestCharMsg.cpp : main source file for TestCharMsg.exe
//
...
//		run nmake -f TestCharMsgps.mk in the project directory.
#include "initguid.h"
#include "TestCharMsg.h"
#include "TestCharMsg_i.c"
...
//	HRESULT hRes = ::CoInitializeEx(NULL, COINIT_MULTITHREADED);
	...
	while(lpszToken != NULL)
	{
		...
		{
			_Module.UpdateRegistryFromResource(IDR_TESTCHARMSG, FALSE);
		...
		{
			_Module.UpdateRegistryFromResource(IDR_TESTCHARMSG, TRUE);
